...
const defaults = {
  ...
  hero2_pc_image: 'assets/store-desktop-hero-clean.webp', hero2_mobile_image: 'assets/store-mobile-hero-clean.webp',
  hero2_label: '손에 담는 작은 예술', hero2_title: '일상을 빛내는\n작은 디테일, 복작소',
  hero2_description: '나무와 천연석에 새긴 고유한 이야기,\n소중한 분과 나 자신만을 위해 정성으로 완성되는 1:1 맞춤 수제 키링',
  hero2_button_text: '대표 작품 보기', hero2_button_url: '#best-section',
  hero3_pc_image: 'assets/store-desktop-hero-clean.webp', hero3_mobile_image: 'assets/store-mobile-hero-clean.webp',
  hero3_label: '손에 담는 작은 예술', hero3_title: '일상을 빛내는\n작은 디테일, 복작소',
  hero3_description: '나무와 천연석에 새긴 고유한 이야기,\n소중한 분과 나 자신만을 위해 정성으로 완성되는 1:1 맞춤 수제 키링',
  hero3_button_text: '대표 작품 보기', hero3_button_url: '#best-section',
